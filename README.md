...
1. Run the `create-component.sh` script. It will accept two user-inputs. First is the name of the component you would like to create. Only alphanumeric characters and dashes (-) are accepted. Second is a description. This will be used for the chart description.
2. This will create a directory under `components` with the configured helm chart.
